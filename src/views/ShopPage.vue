    ...
    <section class="section cta-section">
      <div class="container cta-inner">
        ...
        <div class="cta-btns fade-in-up" style="animation-delay:0.2s">
          ...
          <button class="cta-primary qq-btn" title="点击复制 QQ 号 3230801354" aria-label="点击复制 QQ 号 3230801354" @click="copyQQ">
          ...
          <div class="wechat-cta-wrapper">
            <button class="cta-primary wechat-btn" title="悬浮查看微信二维码，扫码添加" aria-label="悬浮查看微信二维码，扫码添加">
